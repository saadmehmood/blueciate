<?php
$title = 'Integration Solution :- Blueciate Inc';
include('head.php');
?>
<body>
                ...
                <section>
                    <aside class="g lg-twelfths md-one-whole" id="first">
                        ...
                        <p style="max-width: 1200px;">
                            Use the Governance, Compliance & Risk solution to comply with and implement regulatory or internal requirements and detect IT security issues. So, you easily identify and document violations and their elimination. With the License and the Capacity Optimizer you use resources more efficiently reducing costs. Use Cost Allocation to automate costs of IT provision and charge user organizations justly.
                        </p>
                    </aside>
