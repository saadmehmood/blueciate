<?php
$title = 'Enterprise Applications :- Blueciate Inc';
include('head.php');
?>
<body>
                ...
                <section>
                    <aside class="g lg-twelfths md-one-whole" id="first">
                        ...
                        <p style="text-align: center; max-width: 1200px; background: #0A120D; color: white; font-size: 16px">
                            <b>Innovate Your Business Model with ERP CRM BPM</b>
                                <br>
                            Profit from emerging opportunities and market dynamics with our domain expertise and proven methodology.
                        </p>
                        <p style="max-width: 1200px; font-size: 16px;">
                            Thinking Relationship Management by Implementing BPM, CRM, ERP application on cloud using Blueciate Cloud Experience.
                        </p>
                    </aside>
