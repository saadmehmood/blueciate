<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oracle-Suite.aspx.cs"
    Inherits="CreativBees.Cloud.Oracle_Suite" %>
...
<head>
    ...
    <title>Oracle E-Business Suite  :- Blueciate Inc</title>
                ...
                <div class="container">
                    <aside>
                        <div class="g md-one-whole">
                            <h1>5.	Oracle E-Business Suite</h1>
                            <p>
                                Blueciate brings in its immense experience implementing and supporting ERP applications
                                for Fortune 500 companies. We focus on the following services to our valued customers:
                            </p>
                        </div>
                    </aside>
                </div>
                ...
                <div class="container">
                    <section>
                        <aside class="g lg-twelfths md-one-whole" id="first">
                            <h3>Technical implementation of E-Business Suite</h3>
                            <p style="max-width: 1200px;">
                                Blueciate helps with developing conversions and interfaces as part of implementation
                                and upgrade of Oracle E-Business Suite applications and its integration with other
                                applications. Blueciate uses its pre-build framework and technical accelerators
                                (like pre-built generic effort handling capabilities) to provide cost effective
                                and proven delivery model to provide fast-track development solutions.
Oracle uses the combination of one or more of the following Oracle Fusion Middleware components for e-Business suite
                                technical development:
                                <p>
                                    <ul>

                                        <li>Oracle SOA Suite, OSB, Mediator, Application Integration Architecture (AIA), BAM
                                        </li>
