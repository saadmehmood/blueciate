        ...
        <article id="content">
                ...
                <div class="container clearfix">
                    <a class="branding" href="#">
                      <img src="Images/blueciate.png" style="width:200px"/>
                          &nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp &nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp <img src ="Images/cloudline_logo.png" style="width:150px" />
                    </a>
           ...
           <%-- <article class="about-info">--%>
               ...
               <%-- <div class="container block">--%>
                <%-- <div><h2>Own Your Business Line Software on Cloud</h2></div>--%>
                 
                   <div><center><h2>Own Your Business Line Software on Cloud</h2></center></div>
                        ...
                        <div class="g xl-seven-twelfths lg-one-whole md-one-whole no-pad-bottom">
                            <aside class="block block-1">
                                <div class="img-holder">
                                    <img src="Images/Microsoft_Azure.jpg" alt="news" class="background-image" />
                                </div>
                                <div class="content">

                                    <p>
                                        <h2>Why <strong>Blueciate Cloudline</strong></h2>
                                    </p>
                                    <p>
                                        The Cloudline also enables our partners to pursue a number of product technologies available to utilize in a hosted environment, promote cloud services directly to end-user clientele and enjoy the benefits of automatic ServicePoint 365.
                                                                            </p>
                             ...
                             <div class="gw" style="font-size:15px;">
                                ...
                                <div class="content-news color-2">
                                        ...
                                        <p>Microsoft 365 </p>
                                        <small>Office 365 is the brand name Microsoft uses for a group of subscriptions that provide productivity software and related services.For consumers, the subscription allows the use of Microsoft Office apps on Windows, macOS, iOS, Android and Windows 10 Mobile, provides storage space on the OneDrive file hosting service, and grants 60 Skype minutes per month.</small>
                                    </div>
                                <%--<aside class="block-2">
                                <div class="img-holder" style="display:none">
                                    <img src="Images/Bcloudline_logo.jpg" alt="news"  style="display:inline" />
                                </div>
                                 </aside>--%>
                                </div>
                                <div class="g md-one-half wrapper">
                                    <div class="content-news color-2">
                                        ...
                                        <p>Blueciate Cloudline</p>
                                        <small>Blueciate Cloudline displays viable cloud technology solutions and vendors that we have collaborated with to offer a complete package of cloud-based Business solutions to our customers. The Cloudline also enables our partners to pursue a number of product technologies available to utilize in a hosted environment, promote cloud services directly to end-user clientele.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                             ...
                             <div class="gw" style="font-size:15px;">
                                <div class="g xl-one-half lg-one-half md-one-half  sm-one-half  wrapper">
                                    <div class="block-2 flex">
                                        <div class="img-holder">
                                            <img src="images/Surface_logo.png" alt="news" class="background-image" />
                                        </div>
                                ...
                                <div class="g xl-one-half lg-one-half md-one-half  sm-one-half  wrapper">
                                     ...
                                     <div class="block-2 flex">
                                        <div class="img-holder">
                                            <img src="images/Office-365.png" alt="news" class="background-image" />
                                        </div>
                                        
                                    </div>
                                </div>
                                <div class="g xl-one-half lg-one-half md-one-half  sm-one-half  wrapper">
                                    <div class=" block-2 color-2 flex">
                                      <div class="block-2 flex">
                                        <div class="img-holder">
                                            <img src="images/MS-Dynamics365.jpg" alt="news" class="background-image" />
                                        </div>
                                ...
                                <div class="g xl-one-half lg-one-half md-one-half  sm-one-half  wrapper">
                                  <div class=" block-2 color-2 flex">
                                      <div class="block-2 flex">
                                        <div class="img-holder">
                                            <img src="images/ms.jpg" alt="news" class="background-image" />
                                        </div>
