<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OurProducts.aspx.cs" Inherits="CreativBees.OurProducts" %>
                ...
                <div class="container block">
                    <section>
                        <div class="g lg-three-twelfths icon__services">
                          <aside><a href="Products/BlueSpace.aspx" ><i class="fa fa-desktop style"></i></a> </aside>
                            <aside>
                                <div>
                                   <a href="Products/BlueSpace.aspx"> <h4 style="margin-left: 95px;">Bluespace</h4></a>
                                    <p>
                        ...
                        <div class="g lg-three-twelfths icon__services">
                               ...
                               <aside> <a href="http://express.blueciate.com"><i class="fa fa-university style"></i> </a></aside>
                            <aside>
                                <div>
                                  <a href="http://express.blueciate.com" class="hovereffect" ><h4 style="margin-left: 90px;">Blue Express</h4></a>  
                                    <p>
                                        Our innovative, vision-driven team has an in-depth understanding of the tools needed
                                        .
                                    </p>
                        ...
                        <div class="g lg-three-twelfths icon__services">
                            ...
                            <aside><a href="http://icloudline.com">
                               <i class="fa fa-cloud style"></i> </a> </aside>
                            <aside>
                                <div>
                                 <a href="http://icloudline.com"  ><h4 style="margin-left: 90px;">Icloude Line</h4></a> 
                                    <p>
