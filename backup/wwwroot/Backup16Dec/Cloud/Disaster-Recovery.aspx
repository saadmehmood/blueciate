<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disaster-Recovery.aspx.cs"
    Inherits="CreativBees.Cloud.Outsource_Recovery" %>
...
<head>
    ...
    <title>Disaster Recovery  :- Blueciate Inc</title>
                ...
                <div class="container">
                    <aside>
                        <div class="g md-one-whole">
                            <h1>Disaster Recovery (DR)</h1>
                            <p>
                                A recent study discovered that, of companies experiencing a “major loss” of computer
                                records, 43 percent never reopened, 51 percent closed within two years of the loss,
                                and a mere 6 percent survived over the long-term. For small and medium-sized businesses
                                (SMB’s) in particular, these statistics suggest the necessity of crafting a Disaster
                                Recovery & Business.
                                Continuity strategy grounded in a robust data backup and recovery solution.
                    ...
                    <section>
                        <aside class="g lg-twelfths md-one-whole" id="first">
                            ...
                            <p style="max-width: 1200px;">
                                Unlike enterprises, many small and mid-sized businesses cannot afford the optimal
                                in-house strategies and technical solutions required to successfully initiate or
                                execute in the event of a disaster. If this sounds like your business, you are currently
                                running at an elevated risk of being put out of business due to any major loss of
                                data. 
                            </p>
                            <p style="max-width: 1200px;">
                                Loss of data could mean emails lost, accounting data lost, patient or client files
                                lost, company records lost, client legal records or orders lost, and so on. 
                            </p>
                            <p style="max-width: 1200px;">
                                Through our years of experience in this area we know that disaster recovery is a
                                major concern of an entire organization, not just data processing. To develop an
                                effective plan, all departments should be involved. Within all departments the critical
                                needs should be identified. Critical needs include all information and equipment
                                needed in order to continue operations should a department be destroyed or become
                                inaccessible. 
                            </p>
                            <p style="max-width: 1200px;">
                                Our specialist Disaster Recovery Consulting Team can help you devise a near bulletproof
                                Disaster Recovery Plan, so that you can have total piece of mind that your critical
                                systems and processes are safe, and/or can recover from any potential data loss
                                situation.
                            </p>
