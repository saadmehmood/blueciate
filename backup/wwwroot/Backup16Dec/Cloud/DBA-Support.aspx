<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DBA-Support.aspx.cs"
    Inherits="CreativBees.Cloud.DBA_Support" %>
...
<head>
    ...
    <title>Database Administration and Support  :- Blueciate Inc</title>
                ...
                <div class="container">
                    <aside>
                        <div class="g md-one-whole">
                            <h1>Database Administration and Support</h1>
                            <p>
                                Blueciate provides administration, maintenance and support for the following:
                                <h4>Core Oracle DBA services</h4>
                                <h4>Oracle Apps DBA services</h4>
                        ...
                        <aside class="g lg-twelfths md-one-whole" id="first">
                            ...
                            <p style="max-width: 1200px;">
                                <ul>
                                    ...
                                    <li>365x24x7 Support </li>
                                    <li>Flexi-Support Models(8x5, 16x5, 24x5, 24x6, 24x7)</li>
                                    <li>Daily database health checks</li>
                                    <li>Monitoring Dashboard / Alerts</li>
                                    <li>Regular Housekeeping activities</li>
                                    <li>Coordinate with Oracle Support for Service Requests / Technical Assistance Requests
                                    </li>
                                    <li>Monitoring database backups and archives logs</li>
                                    <li>Provide Root Cause Analysis(RCA) and implement solutions to prevent further occurrences
                                    </li>
                                    <li>WiseDesk support for service management</li>
                                    <li>Project management activities(Project planning, Weekly / Daily meetings, Status
                                        reports)</li>
                                    <li>Center of Excellence(Knowledge Management & Database)</li>
