<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Thank-you.aspx.cs" Inherits="CreativBees.Pages.Thank_you" %>
...
<head id="Head1" runat="server">
    ...
    <title>Thank You:- Blueciate Inc</title>
                ...
                <div class="container">
                    <aside>
                        <div class="g md-one-whole">
                            <h1>Thank You for downloading our Product  </h1>
                            <p>
                                We will send you download link where you can download and install our free trial
                                product. During your product trial period we won't be able to provide you any sort
                                of product support. Please read our <a href="../Policies/Terms-Conditions.aspx">Terms
                                    of Use</a> before using our product.
                            </p>
                            <p>
                                Feedback is always welcome. You can send us your feedback at info@blueciate.com
                            </p>
