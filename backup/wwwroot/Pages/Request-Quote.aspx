<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request-Quote.aspx.cs"
    Inherits="CreativBees.Pages.Request_Quote" %>
...
<head id="Head1" runat="server">
    ...
    <title>Request a Trial Version:- Blueciate</title>
                        ...
                        <li><a href="javascript:void(0)">services</a>
                            <ul class="sub-links">
                                <li><a href="../Services/Website-development">Website Development</a></li>
                                    <li><a href="../Services/software-development">Software Development</a></li>
                                    <li><a href="../Services/mobile-app-development">Mobile App Development</a></li>
                                    <li><a href="../Services/helpdesk-solutions">Help Desk Solutions</a></li>
                                    <li><a href="../Services/project-outsourcing">Outsourcing</a></li>
                                    <li><a href="../Services/Staffing">Resource Management</a></li>
            ...
            <div class="container">
                 <div class="gw" style="font-size:15px;">
                    <aside class="g lg-six-twelfths form-section">
                        <section>
                            <h2>Request for  <strong>Trial</strong> Version</h2>
                            <p>Contact <span>Our Company</span></p>
                            <p>
                                Submit below form with your details and we will send you trial version of our product.
                            </p>

                            <aside class="lg-one-whole">
                                <form method="post" name="contact" id="ajax-contact">
                                    <form id="form1" runat="server">
                                        <input type="text" name="name" id="fullname" placeholder="Your Name" class="detail"
                                            runat="server" />
                                        <asp:RequiredFieldValidator ID="valFname" ControlToValidate="fullname" runat="server"
                                            ErrorMessage="Fullname is required!" Display="Dynamic" CssClass="field-validation-error"></asp:RequiredFieldValidator>
                                        <input type="text" name="name" id="dbaName" placeholder="Your Business Name (DBA)"
                                            class="detail" runat="server" />
                                        <input type="text" name="name" id="phone" placeholder="Phone No" class="detail" runat="server" />
                                        <asp:RequiredFieldValidator ID="valPhone" ControlToValidate="phone" runat="server"
                                            ErrorMessage="Phone No. is required!" Display="Dynamic" CssClass="field-validation-error"></asp:RequiredFieldValidator>
                                        <input type="text" name="email" id="email" placeholder="Your Email" class="detail"
                                            runat="server" />
                                        <asp:RequiredFieldValidator ID="valEmail" ControlToValidate="email" runat="server"
                                            ErrorMessage="Email is required!" Display="Dynamic" CssClass="field-validation-error"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="valExpEmail"
                                        ...
                                        <asp:Button ID="btnSubmit" runat="server" CssClass="lnkSubmit" Text="Submit"
                    ...
                    <article id="contact-details">
                        <div class="g lg-six-twelfths ">
                            ...
                            <aside class="box block">
                                <h2 data-color="#29b6f6">Looking for a customized Application?</h2>
                                <p>
                                    Blueciate software developers will help you build a solution to align completely
                            ...
                            <aside class="box block">
                                <h2 data-color="#b39ddb">Visit our location</h2>
                                <p>
                                   777 S Central Expressway Suite 5H, Richardson TX 75080, USA
                                </p>
                            </aside>
