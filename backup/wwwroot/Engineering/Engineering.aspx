                ...
                <div class="container clearfix">
                    <div class="container clearfix">
                        <a class="branding" href="../Default">
                            <img src="../Images/blueciate.png"  style="width:200px"/>
                             &nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp &nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp&nbsp  &nbsp <img src ="../Images/en_logo.png" style="width:150px" />
                        </a>
                            ...
                            <aside class="feature-slider">
                                <ul class="slides">
                                    <li>
                                        <div class="featured-img ">
                                            <div class="img-holder overlay">
                                                <img src="../Images/en2.jpg" alt="blog-featured" class="background-image">
                                            </div>
                                    ...
                                    <li>
                                        <div class="featured-img ">
                                            <div class="img-holder overlay">
                                                <img src="../Images/en3.jpg" alt="blog-featured" class="background-image">
                                            </div>
                                            <div class="inner align-vertical">
                                               <%-- <a href="#">
                                                    <p>Keep your Computer <strong>Running</strong> Like New</p>
                                    ...
                                    <li>
                                        <div class="featured-img ">
                                            <div class="img-holder overlay">
                                                <img src="../Images/e1.jpg" alt="blog-featured" class="background-image">
                                            </div>
                                            <div class="inner align-vertical">
                                               <%-- <a href="#">
                ...
                <div class="container">
                    <section>
                        <aside class="g lg-four-twelfths md-one-whole" id="Aside1">
                            <h3>End-to-end civil engineering services to help you from surveying to final construction
</h3>
                            <p style="font-size: 14px; line-height: 25px;">
                                ...
                                What we have as of now:<br />
                                <div class="middle">
                                <ul>
                               
                               <li> A complete range of professional and cost-effective virtual civil engineering services including construction management, primary surveying and planning from a single source.</li>
                                <li> team of qualified civil engineers who have complete knowledge of standards and regulations in different countries and have worked with the small to large scale construction companies in and outside of India as well.</li>
                               <li>Use of advanced technologies and applications to make the process faster and accurate.</li> 
                                </ul>
                                </div>
                        ...
                        <aside class="g lg-four-twelfths">
                             <div class="gw" style="font-size:15px;">
                                <article class="g lg-one-whole widget md-one-half sm-one-whole">
                                    <span><i class="icon-circle-compass"></i></span>
                                    <aside>
                                        <h3>SERVICES WE CAN OFFER</h3>
                                        <h4>Paper to CAD Conversion Services</h4>
                                        <p style="font-size: 14px; text-justify: auto; width: 300px;">
                                           Today with most engineering companies going paperless, architectural and mechanical drawings are converted to CAD. We can offer CAD conversion and digitization services that make archiving, retrieving, copying, editing and sharing drawings easier.
.
                                        </p>
                                    </aside>
                                </article>
                                ...
                                <article class="g lg-one-whole widget md-one-half sm-one-whole">
                                    ...
                                    <aside>
                                        <h4>Construction Drawings Services</h4>
                                        <p style="font-size: 14px; text-justify: auto; width: 300px;">
                                            A comprehensive construction drawing services are used for analysis, planning, and execution and provide total end-to-end construction process solutions. Using the latest technology and knowledge of worldwide civil engineering code, we have our skilled engineering team with expertise in AutoCAD and Revit to create accurate construction drawings at cost-effective pricing. We can offer drafting of construction drawings for projects like commercial buildings, residential buildings, renovation of old structures, etc. with a turnaround time of 24 hours or as per the need.
                        ...
                        <aside class="g lg-four-twelfths">
                             <div class="gw" style="font-size:15px;">
                                <article class="g lg-one-whole widget md-one-half sm-one-whole">
                                    ...
                                    <aside>
                                        <h4>HVAC Design Services</h4>
                                        <p style="font-size: 14px; text-justify: auto; width: 200px;">
                                            We can provide designing and drafting of HVAC (Heating, Ventilation, and Air Conditioning) needs across global projects. We can provide HVAC designs to architects, builders, contractors, and suppliers, using the latest tools and technologies.
                                        </p>
                                    </aside>
                                </article>
                                ...
                                <article class="g lg-one-whole widget md-one-half sm-one-whole">
                                    ...
                                    <aside>
                                        <h4>We will also offer Architectural services including</h4>
	...
	<li>Electrical Instrumentation Services</li>
	<li>Electrical Design and Layout Services</li>
                        ...
                        <div class="g lg-three-twelfths">
                            <div class="info">
                                <p>
									...
									<strong>BOQ (Bill of quantities)-</strong> 
                                </p>
                                <%--<p>
                                    The bill of quantities (sometimes referred to as 'BoQ') is a document prepared by the cost consultant (often a quantity surveyor) that provides project specific <br />measured quantities of the items of work identified by the drawings and specifications in the tender documentation OUR STRENGTH AS OF NOW.
                                </p>--%>
                                <p>
                                    The bill of quantities (sometimes referred to as 'BoQ') is a document prepared by the cost consultant
                                    (often a quantity surveyor) </p>that provides project specific measured quantities of the items of work identified by the drawings & specifications in the tender documentation. 
                            ...
                            <div class="skills-box">
                                 <div class="gw" style="font-size:15px;">
                                    <div class="g lg-one-half md-one-half ">
                                        <div class="info-2">
                                            <h1>OUR STRENGTH <strong>  AS OF NOW</strong> </h1>
        
                                    <small>what we <span>are good at</span></small>
                                            <p>
                                               We have 2 Architects<br />
                                            Five civil engineers<br />
We have ten 2D & 3D designer (civil & electrical)<br />
Two Quantity surveyors<br />
Three Electrical Engineers<br />
