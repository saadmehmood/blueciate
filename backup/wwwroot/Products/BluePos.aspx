<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BluePos.aspx.cs" Inherits="CreativBees.Products.Amaze_Pos" %>
...
<head>
    ...
    <title>Blue POS :- Blueciate Inc</title>
            ...
            <article class="mobile-nav sticky-off">
                ...
                <nav id="my-menu">
                    <ul>
                        ...
                        <li><a href="javascript:void(0)">Solution</a>
                            <ul class="sub-links">
                                <li><a href="Bluescanplus.aspx">Bluescan Plus</a></li>
                                <!--<li><a href="Products/BluePos?">Blue mPOS</a></li>
                ...
                <div class="container">
                    <aside>
                        <div class="g md-one-whole">
                            <h1>Blue mPOS </h1>
                            <p>
                                Blue mPOS is a Restaurant POS Software. It runs on your PC and supports most POS
                                components such as touch screens, tablets and thermal printers. Blue mPOS actively
                                running on thousands of restaurants across United States. Fully optimized
                                for fast and easy production usage. Very flexible to fit to your business ideas.
                                Just real stuff. Buy Now and start using it now.
                ...
                <div class="container">
                    <section>
                        <aside class="g lg-four-twelfths md-one-whole" id="first">
                            <h3>SMART POS</h3>
                            <p>
                                The BLUE POS software is a ready to use software for fine dine restaurants, take
                                away and quick service restaurant. It is preferred by leading brands in F&B. It
                                is accredited by successful owners and managers of profitable restaurants.
                                    ...
                                    <aside>
                                        ...
                                        <p>
                                            <ul>
                                                ...
                                                <li>Replicates floor plan layout on screen</li>
                                                ...
                                                <li>Create & save receipes</li>
                                                <li>Enter instructions to chef when ordering</li>
                                            </ul>
                                        </p>
                                    </aside>
                                </article>
                                ...
                                <div class="middle">
                                    <nav>
                                        <ul>
                                            ...
                                            <li>Touch Enabled</li>
                                            <li>Customized Print Templates </li>
