    ...
    <div class="row no-gutters">
      ...
      <div class="col-12 col-lg-6 pl-0 pl-lg-1 services-block-four">
        <div class="inner-box wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1500ms"
             style="visibility: visible;animation-duration: 1500ms;animation-delay: 0ms;/* animation-name: fadeInLeft; */">
          <div class="image">
            <img src="./img/trip-cover.jpg" alt="">
            <div class="overlay-box">
              <div class="content">
                <div class="icon-box">
                  <span class="icon flaticon-statistics-1"></span>
...
<div id="go-world" class="d-none">
  <div class="container">
    <div class="row ">
      ...
      <div class="col-lg-7">
        <img src="./index_files/map-1.jpg" class="img-fluid">
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pt-5">
        <img src="./index_files/r-n-m.png" class="img-fluid">
      </div>
    ...
    <div class="row row-flex">
        ...
        <div class="row justify-content-center  bgg-life" style="width: 96%;margin-left: 3%">
          ...
          <div class="col-12 p-3 pt-4">
            <div class="image-logo d-flex justify-content-center" style="height:250px">
              <img src="./index_files/lifestyle.jpg" alt="" class="img-fluid ">
            </div>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="row justify-content-center  bgg-life" style="width: 96%;margin-left: 3%">
          ...
          <div class="col-12 p-3 pt-4">
            <div class="image-logo d-flex justify-content-center" style="height:250px">
              <img src="./index_files/technology.jpg" alt="" class="img-fluid ">
            </div>
          </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="row justify-content-center  bgg-life" style="width: 96%;margin-left: 3%">
          ...
          <div class="col-12 p-3 pt-4">
            <div class="image-logo d-flex justify-content-center" style="height:250px">
              <img src="./index_files/footer-map-2.jpeg" alt="" class="img-fluid ">
            </div>
          </div>
          ...
          <div class="col-12 p-3 ">
            <div class="image-logo d-flex justify-content-center" style="height:250px">
              <img src="./index_files/hotelroom.jpg" alt="" class="img-fluid ">
            </div>
          </div>
          ...
          <div class="col-12 p-3 ">
            <div class="image-logo d-flex justify-content-center" style="height:250px">
              <img src="./index_files/kashmir.jpg" alt="" class="img-fluid ">
            </div>
          </div>
